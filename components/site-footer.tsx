      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.3fr_1fr_1fr_1fr] lg:px-8">
        <div>
          ...
          <p className="mt-5 max-w-sm text-sm leading-7 text-white/62">
            Idaho&apos;s gas piping specialist for natural gas, propane, mechanical systems, water heaters, HVAC, mini splits, and custom residential work.
          </p>
        ...
        <FooterGroup title="Areas" links={serviceAreas.slice(0, 6).map((area) => [area.city, `/service-areas/${area.slug}`])} />
      </div>

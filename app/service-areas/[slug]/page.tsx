...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!area) return {};
  return {
    title: `${area.city} HVAC, Gas Piping & Mechanical Services`,
    description: `${area.summary} ${serviceAreaSentence}`,
  };
}
    ...
    <main>
      <section className="relative overflow-hidden bg-black px-4 py-24 text-white sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <h1 className="max-w-5xl text-5xl font-black leading-[.95] tracking-tight md:text-7xl">HVAC, gas piping, and mechanical services in {area.city}.</h1>
      ...
      <section className="bg-white px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-zinc-600">{serviceAreaSentence}</p>
          </div>
